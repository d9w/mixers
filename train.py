...
if __name__ == "__main__":
    ...
    model = MLPMixer(num_classes=10, image_size=32, patch_size=args.patch_size,
                     hidden_dim=args.hidden, tokens_hidden_dim=args.token,
                     channels_hidden_dim=args.channels, num_layers=args.depth,
                     hidden_dim=512, tokens_hidden_dim=256, channels_hidden_dim=2048,
